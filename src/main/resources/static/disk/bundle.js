...
var _userListCtrl = __webpack_require__(54);

var _userListCtrl2 = _interopRequireDefault(_userListCtrl);

var _userListService = __webpack_require__(56);
...
console.log(angular);
exports.default = angular.module('App.layout', [_angularUiRouter2.default]).config(_layout2.default).controller('userListCtrl', _userListCtrl2.default).service("userListService", _userListService2.default).name;
...
var Http = function () {
    ...
    (0, _createClass3.default)(Http, [{
        ...
        key: 'remove',
        value: function remove(url, params, headers) {
            var promise = new _promise2.default();
            this.$http({
                headers: { 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8' },
                method: 'DELETE',
        ...
        key: 'other',
        value: function other(url, params, headers) {}
    }]);
    return Http;
}();
...
var Util = function () {
    ...
    (0, _createClass3.default)(Util, [{
        key: 'jsonToUrl',
        value: function jsonToUrl(json) {
            if (_lodash2.default.isEmpty(json)) {
                return;
            }

            return (0, _keys2.default)(json).map(function (key, index) {
...
var route = function route($stateProvider, $urlRouterProvider, $locationProvider) {
    // $locationProvider.html5Mode(true);  //设置去掉#号
    $urlRouterProvider.otherwise('/layout'); //默认跳转
};
...
module.exports = "<div>\r\n    <ul>\r\n        <li ng-repeat=\"item in domain.list track by $index\">\r\n             <span ng-show=\"$index%2==0\" style=\"color:red\">*</span>{{item.text}}\r\n             \r\n        </li>\r\n    </ul>\r\n    <input type=\"text\" ng-model=\"domain.addValue\" ng-click='domain.changeValue($event)'>\r\n    <button ng-click=\"domain.add()\" ng-mouseover='domain.hover()' ng-mouseout=\"domain.mouseout()\" ng-class=\"{isActive:domain.isActive}\">新增</button>\r\n    <button ng-click=\"domain.delete()\">删除</button>\r\n    <button ng-click=\"domain.promise()\">promise</button>\r\n    <button ng-click=\"domain.addLink()\">新增一个跳转</button>\r\n    <div id=\"newLink\"></div>\r\n    <style>\r\n       .isActive{\r\n           background: red;\r\n           color:#fff;\r\n       }\r\n    </style>\r\n</div>";
...
var app = _angular2.default.module("App", [_layout2.default, _angularUiRouter2.default]);
app.config(_route2.default);
app.factory("Http", _http2.default);
app.service("Util", _util2.default);
...
var userList = function () {
    function userList(Util, $compile, $scope) {
        (0, _classCallCheck3.default)(this, userList);

        this.message = "这是自定义的userList";
        this.list = [{ ip: "122.122.122.122", text: "llvdc" }];
        this.isActive = false;
        this.addValue = "";
        this.template = { ip: "", text: "" };
    ...
    (0, _createClass3.default)(userList, [{
        key: "add",
        value: function add() {
            var template = (0, _assign2.default)({}, this.template);
            template.text = this.addValue;
        ...
        value: function addLink() {
            var dom = this.$compile("<input type='text' ng-model='childScope.value'>");
            var newDom = dom(this.$scope);
            $("#newLink").html(newDom);
        }
    }]);
    return userList;
...
userList.$inject = ["Util", "$compile", "$scope"];
...
function routes($stateProvider, $urlRouterProvider) {
    $urlRouterProvider.when("/layout", '/layout/userList');
    var userUrl = "./views";
    $stateProvider.state('layout', {
        url: '/layout',
        template: __webpack_require__(105)(userUrl + '/layout.html')
    }).state('layout.userList', {
        url: '/userList',
        views: { //ui-router多路由，@lanout,在layout下面的子路由mainContent的事ui-view="mainContent"里要制定的路由显示
            'mainContent@layout': {
                template: __webpack_require__(106)(userUrl + '/userList.html'),
                controller: 'userListCtrl',
                controllerAs: 'domain' //设置页面数据对象名称对应是$scope下的数据 
            }
        }
...
var userlistService = function userlistService(Http) {
  (0, _classCallCheck3.default)(this, userlistService);
